...
import org.buaa.nlp.cj.designpattern.templatemethod.TemplateMethodTest;

/**
 * Created by I320592 on 8/5/2015.
 */
public class MD5 {
    static final String hexs[] = {"0","1","3","2","4","5","6","7","8","9","a","b","c","d","e","f"};
     ...
     * 将每一个512位的分组再细分成16个小组，每个小组64位（8字节）
     * @param inputBytes
     * @param index
     * @return
     */
    ...
    public static void main(String[] args) {
        byte b = -127;
        System.out.println(b&0x7f + 128);


        MD5 md5 = new MD5();
        String inputStr = "abcasdhfkajlklkdsjlskjflgjsfgowreoijlksjlkfjgslkjfg09834u897jlkdsjf;lksjglksdjfg;lkasdjlqwerty455uiopasdfghjklzxcvbnm123456";
        System.out.println("md5("+inputStr+"):" + md5.digest(inputStr));
    }
